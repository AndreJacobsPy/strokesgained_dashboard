...
class Strokesgained(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    sg_ott = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    sg_t2g = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)
    sg_total = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'strokesgained'
        unique_together = (('player', 'tournament', 'round'),)
